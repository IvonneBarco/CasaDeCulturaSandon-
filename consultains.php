		...
		<div class="row"> <!-- Inicia contenedor-->			
			...
			<section class="posts col-md-9">				
				...
				<br>
						...
						<h2 class="post-title">
								<p class="titulos">SISTEMA DE REGISTRO</p>
						</h2>
						<br>
						...
						<p class="post-contenido text-center font-cs"> 
							Para volver a generar el Recibo, debe ingresar el codigo de inscripcion que fue generado al momento de realizar su inscripcion:
						</p>
						<br>
	                                    ...
	                                    <tr>
	                                        ...
	                                        <div class="input-group">                                                        
	                                        	...
	                                        	<span class="input-group-btn">
	                                            	<input type="submit" class="btn btn-success" name="Generar Recibo"  value="Generar Recibo"/>
