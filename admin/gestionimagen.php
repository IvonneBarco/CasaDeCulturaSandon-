...
<?php if ((isset($_POST["enviado"])) && ($_POST["enviado"] == "form1")) {
	...
	move_uploaded_file($_FILES['userfile']['tmp_name'], "../recursos/uploads/".$nombre_archivo);
...
{?>
	...
	<form action="gestionimagen.php" method="post" enctype="multipart/form-data" id="form1" name="form1">	
			...
			<input type='file' name="userfile" class='form-control' placeholder='Identificacion' aria-describedby='sizing-addon1'>
			<hr>
