                            ...
                            <form  name="fe" action="" method="POST"> 
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <table align="center" class="table table-hover" id="mitabla"> 
                                        <tr>                                        
                                        ...
                                        <tr>
                                            ...
                                            <td><input type='txt' class='form-control' name='txtfechana' id='txtfechana' value="<?php echo $var5?>" placeholder="" readonly aria-describedby='sizing-addon1'></td>
                                        </tr>
                                        <tr>
                                            <td><b>Lugar de Nacimiento </b></td>
                                            <td><input type='txt' class='form-control' name='txtlugar' id='txtlugar' value="<?php echo $var6?>" placeholder="" readonly aria-describedby='sizing-addon1'></td>
                                        </tr>
                                        <tr>
                                            <td><b>Edad </b></td>
