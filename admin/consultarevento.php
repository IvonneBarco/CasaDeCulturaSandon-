...
<title id="titulo">.:: Consultar Eventos</title>
    ...
    <section> <!-- Inicia Pagina Principal -->      
        ...
        <div class="row"> <!-- Inicia contenedor-->         
            ...
            <section class="posts col-md-12">               
                ...
                <div id="divIndex"> 
                    <h2 class="post-title">
                        <p class="titulos"><u>CONSULTAR EVENTOS</u></p><br>
                        <p class="post-contenido text-center font-cs">Para consultar los eventos, debe digitar el codigo del evento.</p>
                    </h2>
                    <br><br>
                        ...
                        <?php
                            ...
                            if(isset($_POST["btn1"])){
                                ...
                                if($btn=="Buscar"){
                                    ...
                                    $sql="select * from evento where codevento='$bus'";
                                    ...
                                    if($codeve!='' and $codigo!='' and $mod!='' and $estado!='' and $version!='' and $fecha!='' and $valor!='' and $descripcion!=''){
                                    $sql="update evento set codevento='$codeve' codigo='$codigo' codmodalidad='$mod' estado='$estado' version='$version' fecha='$fecha' valor='$valor' descripcion='$descripcion' where codevento='$codeve'";
                            ...
                            <form  name="fe" action="" method="POST"> 
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <tr>
                                            <td><b>Código </b></td>
                                            <td><input type='text' class='form-control' name='txtcodeve' id='txtcodeve' value="<?php echo $var?>" placeholder="" readonly aria-describedby='sizing-addon1'><br></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td><b>Fecha </b></td>
                                            <td><input type='txt' class='form-control' name='txtfecha' id='txtfecha' value="<?php echo $var5?>" placeholder="" readonly aria-describedby='sizing-addon1'><br></td>
                                        </tr>
                                        <tr>
                                            <td><b>Valor </b></td>
                                            <td><input type='txt' class='form-control' name='txtvalor' id='txtvalor' value="<?php echo $var6?>" placeholder="" readonly aria-describedby='sizing-addon1'><br></td>
                                        </tr>
                                        <tr>
                                            <td><b>Descripción </b></td>
                                            <td><textarea class='form-control' name='txtdescripcion' id='txtdescripcion' value="<?php echo utf8_encode($var1)?>" placeholder="" readonly aria-describedby='sizing-addon1'></textarea><br></td>
                                        </tr>                                        
                                        <tr>
                                            <td colspan="2">
