...
<title id="titulo">.:: Modificar Usuarios</title>
    ...
    <section> <!-- Inicia Pagina Principal -->      
        ...
        <div class="row"> <!-- Inicia contenedor-->         
            ...
            <section class="posts col-md-12">               
                ...
                <div id="divIndex"> 
                    <h2 class="post-title">
                        <p class="titulos"><u>MODIFICAR USUARIOS</u></p><br>
                        <p class="post-contenido text-center font-cs">Para Modificar al Usuario, ingrese su identificación</p>
                    </h2><br>
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="txtid" readonly="true" value="<?php echo $var?>" class='form-control' aria-describedby='sizing-addon1'/><br></td>
                        </tr>

                        <tr>
                            <th>Usuario</th>
                            <td><input type="text" name="txtusuario_nombre"  value="<?php echo $var1?>" class='form-control' aria-describedby='sizing-addon1'/><br></td>
                        </tr>

                        <tr>
                            <th>Clave</th>
                            <td><input type="password" name="txtusuario_clave"  value="<?php echo $var2?>" class='form-control' aria-describedby='sizing-addon1'/><br></td>
                        </tr>

                        <tr>
                            <th>E-mail</th>
                            <td><input type="text" name="txtusuario_email"  value="<?php echo $var3?>" class='form-control' aria-describedby='sizing-addon1'/><br></td>
                        </tr>
                        <tr>
                            <th colspan="2"><center><input type="submit" name="btn1" value="Actualizar" class='btn btn-success' aria-describedby='sizing-addon1'/></center><br></th>
                        </tr>    
                        </table>
                        </form>
