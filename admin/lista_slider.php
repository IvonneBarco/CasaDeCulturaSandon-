...
<head>
    ...
    <title id="titulo">.:: Listar Usuarios</title>
        ...
        <div class="migas-de-pan"> <!--Inicia migas de pan-->       
          <ol class="breadcrumb" id="miga">
            ...
            <li class="active">Listar Usuarios</li>
                    ...
                    <h2 class="post-title">
                        <p class="titulos"><u>LISTADO DE USUARIOS</u></p><br>
                    </h2>
        ...
        <div class="col-md-12">
            ...
            <table class="table table-bordered table-hover" >
                <tbody>
                  ...
                  <?php do { ?>
                  <tr>
                    <td><?php echo $row_ms_slider['descripcion']; ?></td>
                    <td><img src="../recursos/uploads/<?php echo $row_ms_slider['imagen']; ?>" width="140" height="160"></td>
