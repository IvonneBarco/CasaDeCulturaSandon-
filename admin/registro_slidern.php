			...
			<section class="posts col-md-12">				
				<div class="migas-de-pan"> <!--Inicia migas de pan-->				
					<ol class="breadcrumb" id="miga">
						...
						<li class="active">Registrar Noticias</li>
					</ol>
...
<section id="personal">
					...
					<h2 class="post-title">
                        <p class="titulos"><u>REGISTRAR NOTICIAS</u></p><br>
                    </h2>
...
<footer>
			<!--<div class="panel-body" id="divFooter">
				...
				<div class="col-xs-4" align="center">
					<a href="#"><img src="images/alcalde.png" alt="alcalde" class="img-responsive" id="logos"></a>
				</div>
				<div class="col-xs-4" align="center">
					<a href="#"><img src="images/liberal.png" alt="liberal" class="img-responsive" id="logos"></a>
				</div>
				<div class="col-xs-4" align="center">
					<a href="#"><img src="images/caña.png" alt="caña" class="img-responsive" id="logos"></a>
				</div>
			</div> </div>-->
