...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE personal SET descripcion=%s, imagen=%s WHERE identificacion=%s",
...
<div class="row">
  ...
  <div class="col-md-8">
	    ...
	    <div class="form-group">
			...
			<input type="text" class="form-control" name="descripcion" value="<?php echo $row_edit_slider['descripcion']; ?>"  required>
		</div>
		<div class="form-group">
